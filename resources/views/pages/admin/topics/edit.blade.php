                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Edit Topik</div>
                        </div>
                    </div>
                            ...
                            <form action="{{ route('topics.update', [$resource->id]) }}" method="POST"
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="25">{{ $resource->description }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-12">
                                        @if (substr($resource->image, 0, 5) == 'https')
                                            <img src="{{ $resource->image }}" class="img-thumbnail" width="500"
                                                alt="image_village">
                                        @else
                                            <img src="{{ Storage::url('/assets/images/' . $resource->image) }}"
                                                class="img-thumbnail" width="500" alt="image_village">
                                        @endif
                                    </div>
                                </div>
